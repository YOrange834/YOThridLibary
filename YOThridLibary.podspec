#
#  Be sure to run `pod spec lint YOThridLibary.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "huangcheng" => "" }
  # Or just: spec.author    = "huangcheng"
  # spec.authors            = { "huangcheng" => "" }
  # spec.social_media_url   = "https://twitter.com/huangcheng"
  ...
  spec.source       = { :git => "https://github.com/YOrange834/YOThridLibary.git", :tag => "#{spec.version}" }
